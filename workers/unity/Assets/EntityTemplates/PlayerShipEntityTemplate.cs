...
/*
* Disabled the lifecycle for now. hope it works.
*/
public class PlayerShipEntityTemplate : MonoBehaviour
{
	...
	static public Entity GeneratePlayerShipEntityTemplate(string clientWorkerId, Coordinates initialPosition)
	{
		...
		playerEntityTemplate.Add(new WorldTransform.Data(new WorldTransformData(initialPosition, 0))); //WorldTransformData(initialPosition,0)
