...
public static partial class SgtHelper
{
	...
	public static void MakeTextureTruecolor(Texture2D texture)
	{
		if (texture != null)
		{
			...
			if (importer != null)
			{
				if (importer.textureFormat != TextureImporterFormat.ARGB32 && importer.textureFormat != TextureImporterFormat.AutomaticTruecolor && importer.textureFormat != TextureImporterFormat.RGBA32)
				{
