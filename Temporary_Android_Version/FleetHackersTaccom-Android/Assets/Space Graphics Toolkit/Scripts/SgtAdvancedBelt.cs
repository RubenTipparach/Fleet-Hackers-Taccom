...
public class SgtAdvancedBelt : SgtBelt
{
	...
	[Tooltip("The distribution of asteroid distances in local coordinates")]
	public AnimationCurve DistanceDistribution;

	[Tooltip("The distribution of asteroid heights in local coordinates")]
	...
	[Tooltip("The distribution of asteroid radii in local coordinates")]
