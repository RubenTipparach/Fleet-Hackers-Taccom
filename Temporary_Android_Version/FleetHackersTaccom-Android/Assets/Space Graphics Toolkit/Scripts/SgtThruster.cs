...
public class SgtThruster : MonoBehaviour
{
	...
	// The current GameObject for the flame effect
	[FormerlySerializedAs("flame")]
	public SgtThrusterFlame Flame;
	
	// The current GameObject for the flare effect
	[FormerlySerializedAs("flare")]
	public SgtThrusterFlare Flare;
